...
VALUES
  ('P001', 'Bút bi', 'Cái', 1.99, 100),
  ('P002', 'Giấy A4', 'Tờ', 5.99, 500),
  ('P003', 'Mực in', 'Lọ', 8.49, 50);
...
VALUES
  ('EMP001', 'John Doe', '1990-05-15', 1, 'john.doe@example.com', '123-456-7890', '123 Main St, City', 'johndoe', 'password123', 'Sales Associate', 50000, '2022-03-10', 'ST001'),
  ('EMP002', 'Alex Smith', '1985-08-20', 0, 'alex.smith@example.com', '987-654-3210', '456 Elm St, Town', 'alexsmith', 'secret789', 'Manager', 65000, '2021-12-15', 'ST001'),
  ('EMP003', 'Bob Johnson', '1995-02-28', 1, 'bob.johnson@example.com', '555-123-7890', '789 Oak St, Village', 'bobjohnson', 'bobspass', 'Sales Associate', 48000, '2022-05-20', 'ST002'),
  ('EMP004', 'Alice Lee', '1998-04-10', 0, 'alice.lee@example.com', '777-333-2222', '321 Pine St, County', 'alicelee', 'p@ssw0rd', 'Intern', 30000, '2023-01-05', 'ST001'),
  ('EMP005', 'Ben Scalet', '1998-04-10', 1, 'ben.scalet@example.com', '135-234-7890', '115 Pine St, County', 'benscalet', '123ben', 'Intern', 40000, '2023-02-13', 'ST002');


-- Sales_teams
INSERT INTO sales_team (id, name, revenue_target, team_leader_id, pipeline_id)
VALUES
  ('ST001', 'Sales Team', 1000000, 'EMP001', 'PL001'),
  ('ST002', 'Post-Sales Team', 800000, 'EMP003', 'PL002');


-- Customer
INSERT INTO customer (id, full_name, date_of_birth, gender, email, phone, address, is_company, buy_rank, create_date)
VALUES
  ('C001', 'Sarah Adams', '1987-09-12', 0, 'sarah.adams@example.com', '555-789-1234', '456 Oak St, Town', 0, 4, '2022-11-25 13:40:00'),
  ('C002', 'Michael Brown', '1993-03-30', 1, 'michael.brown@example.com', '888-999-7777', '789 Elm St, City', 0, 5, '2022-08-15 16:10:00'),
  ('C003', 'Linda Wilson', '1980-07-22', 0, 'linda.wilson@example.com', '777-222-3333', '321 Main St, Village', 1, 2, '2023-02-18 09:55:00'),
  ('C004', 'Daniel Miller', '1991-01-05', 1, 'daniel.miller@example.com', '123-987-6543', '987 Pine St, County', 0, 3, '2022-10-10 10:30:00');


-- Stage
INSERT INTO stage (id, name)
VALUES
  ('Stage001', 'Lead qualification'),
  ('Stage002', 'Demo or meeting (telephone, email, real-life meeting..)'),
  ('Stage003', 'Create proposal for pre-sales'),
  ('Stage004', 'Create proposal for up-sales'),
  ('Stage005', 'Negotiation and manage expectation'),
  ('Stage006', 'Opportunity won');


-- Pipeline
INSERT INTO pipeline (id, name)
VALUES
  ('PL001', 'Sales Pipeline'),
  ('PL002', 'Up-Sales Pipeline');
...
VALUES
  ('PL001', 'Stage001', 1), -- Lead qualification
  ('PL001', 'Stage002', 2), -- Demo or meeting
  ('PL001', 'Stage003', 3), -- Create proposal for pre-sales
  ('PL001', 'Stage005', 4), -- Negotiation and manage expectation
  ('PL001', 'Stage006', 5); -- Opportunity won


-- Up-sales pipeline
INSERT INTO pipeline_stage (pipeline_id, stage_id, stage_order)
VALUES
  ('PL002', 'Stage004', 1), -- Create proposal for up-sales
  ('PL002', 'Stage002', 2), -- Demo or meeting
  ('PL002', 'Stage005', 3), -- Negotiation and manage expectation
  ('PL002', 'Stage006', 4); -- Opportunity won


-- Order
INSERT INTO [order] (id, order_date, ship_address, ship_date, customer_id, employee_id, lead_status_id)
VALUES
  ('Order001', '2023-11-20 13:45:00', '456 Oak St, Town', '2023-11-25 15:30:00', 'C001', 'EMP001', 'LS005'),
  ('Order002', '2023-11-25 10:30:00', '789 Elm St, City', '2023-11-30 12:40:00', 'C002', 'EMP002', 'LS006'),
  ('Order003', '2023-12-01 14:30:00', '321 Main St, Village', '2023-12-05 10:00:00', 'C003', 'EMP003', 'LS005'),
  ('Order004', '2023-12-05 09:45:00', '987 Pine St, County', '2023-12-10 11:30:00', 'C004', 'EMP004', 'LS001'),
  ('Order005', '2023-12-10 16:20:00', '456 Oak St, Town', '2023-12-15 14:15:00', 'C001', 'EMP001', 'LS002'),
  ('Order006', '2023-12-15 11:10:00', '789 Elm St, City', '2023-12-20 09:20:00', 'C002', 'EMP002', 'LS003');


-- Marketing_campaign "Black Friday"
INSERT INTO marketing_campaign (id, name, start_date, end_date)
VALUES
  ('MC001', 'Black Friday', '2023-11-24', '2023-12-01');


-- Customer_marketing_campaign
INSERT INTO customer_marketing_campaign (customer_id, marketing_campaign_id, sent_date, channel)
VALUES
  ('C001', 'MC001', '2023-11-02', 'Email'),
  ('C002', 'MC001', '2023-11-03', 'SMS');
...
VALUES
  ('Reason001', 'No Budget'),
  ('Reason002', 'Not Interested'),
  ('Reason003', 'Competitor Chose');

-- Lead_status
INSERT INTO lead_status (id, status, create_date, lost_reason_id)
VALUES
  ('LS001', 1, '2023-11-01 14:30:00', NULL), -- Thành công
  ('LS002', 1, '2023-11-05 09:45:00', NULL), -- Thành công
  ('LS003', 0, '2023-11-10 16:20:00', 'Reason001'); -- Thất bại với lý do
...
VALUES
  ('LO001', 'Opportunity 1 for C001', 3, 5000, '2023-11-10 14:30:00', '2023-11-01 14:30:00', 'Source001', 'EMP001', 'MC001'), -- Thành công
  ('LO002', 'Opportunity 2 for C001', 2, 8000, '2023-11-15 09:45:00', '2023-11-05 09:45:00', 'Source002', 'EMP001', 'MC001'); -- Thành công

-- Lead_opportunity for C002
INSERT INTO lead_oppurtunity (id, name, urgency, expected_revenue, expected_closing_date, create_date, source_id, create_employee_id, marketing_campaign_id)
VALUES
  ('LO003', 'Opportunity for C002', 1, 6000, '2023-11-10 16:20:00', '2023-11-10 16:20:00','Source001', 'EMP002', NULL); -- Thất bại
